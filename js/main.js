  ...
  tabBtns.forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      if (currentAppLang === 'tr') {
        src = 'assets/images/banner-turkish.jpg';
      } else if (currentAppLang === 'en') {
        src = 'assets/images/banner-english.jpg';
      } else {
        if (target === 'office') src = 'assets/images/banner-office.png';
        else if (target === 'home') src = 'assets/images/banner-home.png';
        else src = 'assets/images/banner-apartment.png';
      }
...
function applyLanguage(lang) {
  ...
  if (heroMainImg) {
    ...
    if (lang === 'tr') {
      targetSrc = 'assets/images/banner-turkish.jpg';
    } else if (lang === 'en') {
      targetSrc = 'assets/images/banner-english.jpg';
    } else {
      if (target === 'office') targetSrc = 'assets/images/banner-office.png';
      else if (target === 'home') targetSrc = 'assets/images/banner-home.png';
